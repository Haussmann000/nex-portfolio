  ...
  <div className={style.container}>
    <div className={style.profile}>
      <div>
        ...
        <p>
          ...
          electronic typesetting, remaining essentially unchanged. It was popularised in the 1960 s with the release
    ...
    <div className={style.skills}>
      ...
      <div className={style.skillsContainer}>
        ...
        <div>
          <img src="/images/react.svg" alt="react" /><span>
            React / 5 years </span>
        </div>
        <div>
        ...
        <div>
          <img src="/images/next. svg" alt="next" /><span>
            Next. JS / 3 years </span>
        </div>
      </div>
    </div>
